...
mod test {
    ...
    impl Into<Local<Token>> for CharToken {
        fn into(self) -> Local<Token> {
            self.token.localize(Snip { offset: self.char_offset, length: self.char_length },
                                Snip { offset: self.byte_offset, length: self.byte_length })
        }
    }
    ...
    impl Into<Local<Token>> for PositionalToken {
        fn into(self) -> Local<Token> {            
            self.token.localize(Snip { offset: self.source[.. self.offset].chars().count(),
                                       length: self.source[self.offset .. self.offset + self.length].chars().count() },
                                Snip { offset: self.offset, length: self.length })
        }
    }
    ...
    fn check<T: Clone + std::fmt::Debug + Into<Local<Token>>>(res: &Vec<T>, lib: &Vec<Local<Token>>, _uws: &str) {
    ...
    fn hashtags() {
        ...
        let result = vec![
            PositionalToken { source: uws, offset: 0, length: 1, token: Token::Special(Special::Punctuation('#')) },
            PositionalToken { source: uws, offset: 1, length: 7, token: Token::Word(Word::Word("hashtag".to_string())) },
            PositionalToken { source: uws, offset: 8, length: 1, token: Token::Special(Special::Punctuation('#')) },
    ...
    fn apostrophe() {
        ...
        let result = vec![
            ...
            PositionalToken { source: uws, offset: 7, length: 1, token: Token::Special(Special::Punctuation(';')) },
    ...
    fn char_tokens() {
        ...
        let result = vec![
            CharToken { byte_offset: 0, byte_length: 1, char_offset: 0, char_length: 1, token: Token::Special(Special::Punctuation('[')) },
            ...
            CharToken { byte_offset: 12, byte_length: 1, char_offset: 12, char_length: 1, token: Token::Special(Special::Punctuation('|')) },            
            ...
            CharToken { byte_offset: 23, byte_length: 1, char_offset: 23, char_length: 1, token: Token::Special(Special::Punctuation(']')) },
            ...
            CharToken { byte_offset: 42, byte_length: 1, char_offset: 42, char_length: 1, token: Token::Special(Special::Punctuation('(')) },
            CharToken { byte_offset: 43, byte_length: 1, char_offset: 43, char_length: 1, token: Token::Special(Special::Punctuation('"')) },
            CharToken { byte_offset: 44, byte_length: 5, char_offset: 44, char_length: 5, token: Token::Word(Word::Word("brown".to_string())) },
            CharToken { byte_offset: 49, byte_length: 1, char_offset: 49, char_length: 1, token: Token::Special(Special::Punctuation('"')) },
            CharToken { byte_offset: 50, byte_length: 1, char_offset: 50, char_length: 1, token: Token::Special(Special::Punctuation(')')) },
            ...
            CharToken { byte_offset: 76, byte_length: 1, char_offset: 76, char_length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            CharToken { byte_offset: 83, byte_length: 1, char_offset: 83, char_length: 1, token: Token::Special(Special::Punctuation('?')) },
            ...
            CharToken { byte_offset: 93, byte_length: 1, char_offset: 93, char_length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            CharToken { byte_offset: 115, byte_length: 1, char_offset: 115, char_length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            CharToken { byte_offset: 129, byte_length: 1, char_offset: 128, char_length: 1, token: Token::Special(Special::Punctuation('!')) },
            ...
            CharToken { byte_offset: 240, byte_length: 1, char_offset: 191, char_length: 1, token: Token::Special(Special::Punctuation('-')) },
            CharToken { byte_offset: 241, byte_length: 12, char_offset: 192, char_length: 6, token: Token::Word(Word::Word("словам".to_string())) },
            CharToken { byte_offset: 253, byte_length: 3, char_offset: 198, char_length: 3, token: Token::Special(Special::Punctuation('.')) },
            ...
            CharToken { byte_offset: 300, byte_length: 1, char_offset: 215, char_length: 1, token: Token::Special(Special::Punctuation('+')) },
            CharToken { byte_offset: 301, byte_length: 4, char_offset: 216, char_length: 4, token: Token::Word(Word::Word("Done".to_string())) },
            CharToken { byte_offset: 305, byte_length: 1, char_offset: 220, char_length: 1, token: Token::Special(Special::Punctuation('!')) },
    ...
    fn general_default() {
        ...
        let result = vec![
            ...
            PositionalToken { source: uws, offset: 10, length: 1, token: Token::Special(Special::Punctuation('(')) },
            PositionalToken { source: uws, offset: 11, length: 1, token: Token::Special(Special::Punctuation('"')) },
            PositionalToken { source: uws, offset: 12, length: 5, token: Token::Word(Word::Word("brown".to_string())) },
            PositionalToken { source: uws, offset: 17, length: 1, token: Token::Special(Special::Punctuation('"')) },
            PositionalToken { source: uws, offset: 18, length: 1, token: Token::Special(Special::Punctuation(')')) },
            ...
            PositionalToken { source: uws, offset: 44, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 51, length: 1, token: Token::Special(Special::Punctuation('?')) },
            ...
            PositionalToken { source: uws, offset: 61, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 68, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 69, length: 1, token: Token::Word(Word::Word("S".to_string())) },
            PositionalToken { source: uws, offset: 70, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 83, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 97, length: 1, token: Token::Special(Special::Punctuation('!')) },
            ...
            PositionalToken { source: uws, offset: 138, length: 1, token: Token::Special(Special::Punctuation('#')) },
            ...
            PositionalToken { source: uws, offset: 208, length: 1, token: Token::Special(Special::Punctuation('-')) },
            PositionalToken { source: uws, offset: 209, length: 12, token: Token::Word(Word::Word("словам".to_string())) },
            PositionalToken { source: uws, offset: 221, length: 3, token: Token::Special(Special::Punctuation('.')) },
    ...
    fn plus_minus() {
        ...
        let result = vec![
            ...
            PositionalToken { source: uws, offset: 19, length: 1, token: Token::Special(Special::Punctuation('-')) },
            ...
            PositionalToken { source: uws, offset: 23, length: 1, token: Token::Special(Special::Punctuation('+')) },
    ...
    fn emoji_and_rusabbr_default() {
        ...
        let result = vec![
            ...
            PositionalToken { source: uws, offset: 50, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 51, length: 2, token: Token::Word(Word::Word("С".to_string())) },
            PositionalToken { source: uws, offset: 53, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 54, length: 2, token: Token::Word(Word::Word("С".to_string())) },
            PositionalToken { source: uws, offset: 56, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 57, length: 2, token: Token::Word(Word::Word("Р".to_string())) },
            PositionalToken { source: uws, offset: 59, length: 1, token: Token::Special(Special::Punctuation('.')) },
    ...
    fn html() {
        ...
        let result = vec![
            ...
            PositionalToken { source: uws, offset: 329, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 371, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 387, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 412, length: 3, token: Token::Special(Special::Punctuation('—')) },
            ...
            PositionalToken { source: uws, offset: 458, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 481, length: 2, token: Token::Special(Special::Punctuation('«')) },
            ...
            PositionalToken { source: uws, offset: 500, length: 2, token: Token::Special(Special::Punctuation('»')) },
            PositionalToken { source: uws, offset: 502, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 600, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 690, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 1138, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 1233, length: 2, token: Token::Special(Special::Punctuation('«')) },
            ...
            PositionalToken { source: uws, offset: 1252, length: 2, token: Token::Special(Special::Punctuation('»')) },
            PositionalToken { source: uws, offset: 1254, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 1371, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 1394, length: 1, token: Token::Special(Special::Punctuation(',')) },
            ...
            PositionalToken { source: uws, offset: 1562, length: 1, token: Token::Special(Special::Punctuation('.')) },
    ...
    fn numerical_default() {
        ...
        let result = vec![
            ...
            PositionalToken { source: uws, offset: 2, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 3, length: 2, token: Token::Word(Word::Number(Number::Integer(2))) },
            PositionalToken { source: uws, offset: 5, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 14, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 20, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 32, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 33, length: 3, token: Token::Word(Word::Number(Number::Integer(568))) },
            PositionalToken { source: uws, offset: 36, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 37, length: 3, token: Token::Word(Word::Number(Number::Integer(365))) },
            PositionalToken { source: uws, offset: 40, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 52, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 53, length: 1, token: Token::Word(Word::Number(Number::Integer(0))) },
            PositionalToken { source: uws, offset: 54, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            PositionalToken { source: uws, offset: 127, length: 1, token: Token::Special(Special::Punctuation('_')) },
            PositionalToken { source: uws, offset: 128, length: 3, token: Token::Word(Word::Number(Number::Integer(123))) },
            PositionalToken { source: uws, offset: 131, length: 1, token: Token::Special(Special::Punctuation('_')) },
            PositionalToken { source: uws, offset: 132, length: 3, token: Token::Word(Word::Number(Number::Integer(343))) },
            PositionalToken { source: uws, offset: 135, length: 1, token: Token::Special(Special::Punctuation('.')) },
            PositionalToken { source: uws, offset: 136, length: 4, token: Token::Word(Word::Number(Number::Integer(4234))) },
            PositionalToken { source: uws, offset: 140, length: 1, token: Token::Special(Special::Punctuation('_')) },
    ...
    fn get_lang_test(lng: Lang) -> (String, Vec<PositionalToken>) {
        ...
        let tokens = match lng {
            Lang::Zho => vec![
                ...
                PositionalToken { source: uws, offset: 21, length: 3, token: Token::Special(Special::Punctuation('《')) },
                ...
                PositionalToken { source: uws, offset: 36, length: 3, token: Token::Special(Special::Punctuation('》')) },
                ...
                PositionalToken { source: uws, offset: 51, length: 3, token: Token::Special(Special::Punctuation('《')) },
                ...
                PositionalToken { source: uws, offset: 63, length: 3, token: Token::Special(Special::Punctuation('》')) },
                ...
                PositionalToken { source: uws, offset: 104, length: 3, token: Token::Special(Special::Punctuation('，')) },
                ...
                PositionalToken { source: uws, offset: 137, length: 2, token: Token::Special(Special::Punctuation('·')) },
                ...
                PositionalToken { source: uws, offset: 157, length: 2, token: Token::Special(Special::Punctuation('·')) },
                ...
                PositionalToken { source: uws, offset: 171, length: 3, token: Token::Special(Special::Punctuation('，')) },
                ...
                PositionalToken { source: uws, offset: 180, length: 2, token: Token::Special(Special::Punctuation('·')) },
                ...
                PositionalToken { source: uws, offset: 197, length: 3, token: Token::Special(Special::Punctuation('。')) },
                ...
                PositionalToken { source: uws, offset: 245, length: 2, token: Token::Special(Special::Punctuation('·')) },
                ...
                PositionalToken { source: uws, offset: 259, length: 3, token: Token::Special(Special::Punctuation('，')) },
            ...
            Lang::Jpn => vec![
                ...
                PositionalToken { source: uws, offset: 24, length: 3, token: Token::Special(Special::Punctuation('、')) },
                ...
                PositionalToken { source: uws, offset: 68, length: 3, token: Token::Special(Special::Punctuation('（')) },
                ...
                PositionalToken { source: uws, offset: 83, length: 3, token: Token::Special(Special::Punctuation('、')) },
                ...
                PositionalToken { source: uws, offset: 98, length: 3, token: Token::Special(Special::Punctuation('、')) },
                ...
                PositionalToken { source: uws, offset: 113, length: 3, token: Token::Special(Special::Punctuation('）')) },
                ...
                PositionalToken { source: uws, offset: 125, length: 3, token: Token::Special(Special::Punctuation('・')) },
                ...
                PositionalToken { source: uws, offset: 179, length: 3, token: Token::Special(Special::Punctuation('。')) },
                ...
                PositionalToken { source: uws, offset: 207, length: 3, token: Token::Special(Special::Punctuation('、')) },
                ...
                PositionalToken { source: uws, offset: 285, length: 3, token: Token::Special(Special::Punctuation('、')) },
            ...
            Lang::Kor => vec![
                ...
                PositionalToken { source: uws, offset: 111, length: 1, token: Token::Special(Special::Punctuation('.')) },
                ...
                PositionalToken { source: uws, offset: 154, length: 1, token: Token::Special(Special::Punctuation(',')) },
                ...
                PositionalToken { source: uws, offset: 195, length: 1, token: Token::Special(Special::Punctuation('.')) },
            ...
            Lang::Ell => vec![
                ...
                PositionalToken { source: uws, offset: 184, length: 1, token: Token::Special(Special::Punctuation('/')) },
                ],
        };
